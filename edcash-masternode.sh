...
echo "rpcport=54582" >> /root/.edcash/edcash.conf
...
IPR=$(curl -s4 icanhazip.com)
echo "set in windows you masternode.conf ex: mn1 $IPR:5003 $KEY TXID INDEX"
